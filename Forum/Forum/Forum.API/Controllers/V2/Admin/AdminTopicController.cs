...
namespace Forum.API.Controllers.V2.Admin
{
    /// <summary>
    ...
    public class AdminTopicController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdminTopicController"/> class.
        /// </summary>
        ...
        /// Retrieves all topics, with count of comments.
        /// </summary>
        /// <param name="id">The unique id of Topic</param>
        /// <param name="pageNumber">The page number for pagination.</param>
        /// <param name="pageSize">The size of each page.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A paged list of admin topic details.</returns>
